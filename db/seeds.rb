...
EmailMessage.create(email: 'Student Reminder', title: 'Reminder:', header: "You have an appointment scheduled for:", footer: "If you need to cancel or add an event, please contact the coordinator. Thank you for participating and have a great day!")
