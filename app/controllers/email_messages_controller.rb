class EmailMessagesController < ApplicationController
  ...
  def show
    if @email_message.email == "Delete Company"
      render "user_mailer/com_del"
    elsif @email_message.email == "Register Company"
      render "user_mailer/com_reg"
    elsif @email_message.email == "Register Student"
      render "user_mailer/stu_reg"
    elsif @email_message.email == "Delete Student"
      render "user_mailer/stu_del"
    elsif @email_message.email == "Student Reminder"
      render "user_mailer/stu_reminder"
    end
  ...
  private
    ...
    def email_message_params
      params.require(:email_message).permit(:email, :title, :header, :footer)
    end
end
